...
/**
 * Schema that describes one scoring period during the season. Has a number for the period
 * is represents and an array of sub docs which consist of the owners ranks for that period
 */
